...
const EVENT_META: Record<string, { glyph: string; label: string }> = {
  ...
  schedule_created: { glyph: "SC", label: "Schedule created" },
  schedule_deleted: { glyph: "SD", label: "Schedule deleted" },
  schedule_disabled: { glyph: "SX", label: "Schedule disabled" },
  schedule_enabled: { glyph: "SE", label: "Schedule enabled" },
